<tr class="hover:bg-blue-50 transition-all duration-200">
    ...
    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-700">{{ $tag->slug }}</td>
    ...
    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-700">
        <a href="{{ route('tag.index', $tag->slug) }}" class="text-blue-600 hover:text-blue-800 hover:underline font-semibold transition-all duration-200">Pogledaj postove</a>
    </td>
